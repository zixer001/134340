	...
	<div class="pcoded-content">
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						<h5 class="text-dark">ตัดเครดิต เครดิตปัจจุบัน <?php echo $Balance; ?> <a href="member.php" class="btn btn-success float-right">ย้อนกลับ</a>
						</h5>
						<hr>
						<div class="container">
							<div class="row">

								<form class="form-horizontal ng-pristine ng-valid" method="POST" action="api/tran_betflix.php?withdraw" enctype="multipart/form-data">
									<input type="text" name="username" value="<?php echo $agent . $username_mb; ?>" hidden>
									<input type="text" name="admin" value="<?php echo $name_ad; ?>" hidden>
									<div class="form-group">
										<div class="row">
											<label class="col-sm-4 control-label requiredField">
												ใส่จำนวนเครดิตที่ต้องการตัดออก
