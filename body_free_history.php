	...
	<div class="pcoded-content">
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						<h5 class="text-dark">ค้นหาประวัติรับเครดิตฟรี
								...
								<div class="col-md-12">
									...
									<form action="" method="GET" class="form-horizontal">
										<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="text" name="phone_dp" required class="form-control" placeholder="กรอกเบอร์โทรศัพท์ หรือ ยูสเซอร์เนม">
												<br>
									...
									<div class="table-responsive">
										...
										if ($act == 'search') {
											...
											$query = "SELECT * FROM deposit WHERE confirm_dp != 'รอดำเนินการ' AND bankin_dp = 'ไม่ถูกต้อง' AND amount_dp!='รอฝาก' AND phone_dp LIKE '%$phone%' OR username_dp LIKE '%$test%' ORDER BY id DESC";
										} elseif ($act == 100) {
											$query = "SELECT * FROM deposit WHERE confirm_dp != 'รอดำเนินการ' AND bankin_dp = 'ไม่ถูกต้อง' AND amount_dp!='รอฝาก' ORDER BY id DESC LIMIT 100";
										} elseif ($act == 500) {
											$query = "SELECT * FROM deposit WHERE confirm_dp != 'รอดำเนินการ' AND bankin_dp = 'ไม่ถูกต้อง' AND amount_dp!='รอฝาก' ORDER BY id DESC LIMIT 500";
										} elseif ($act == 1000) {
											$query = "SELECT * FROM deposit WHERE confirm_dp != 'รอดำเนินการ' AND bankin_dp = 'ไม่ถูกต้อง' AND amount_dp!='รอฝาก' ORDER BY id DESC LIMIT 1000";
										} else{
											$query = "SELECT * FROM deposit WHERE confirm_dp != 'รอดำเนินการ' AND bankin_dp = 'ไม่ถูกต้อง' AND amount_dp!='รอฝาก' ORDER BY id DESC";
										}
			...
			<th align='center'>ธนาคารที่โอนเข้า</th>
			...
			<th align='center'>แก้ไข</th>
										...
										while ($row = mysqli_fetch_array($result)) {
											...
											echo "<td align='center'>" . $row["bankin_dp"] .  "</td> ";
											...
											//แก้ไขข้อมูล
											echo "<td align='center'><a href='depositupdateform.php?id=$row[0]'><button class='btn btn-primary '><font color='white'>แก้ไข</font></button></a></td> ";
