	...
	<div class="pcoded-content">
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						<h5 class="text-dark">ค้นหารายการแนะนำเพื่อน
								...
								<div class="col-md-12">
									...
									<form action="" method="GET" class="form-horizontal">
										<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="text" name="phone_dp" class="form-control" placeholder="กรอกรหัสแนะนำเพื่อน">
											</div>
		...
		<div class="col-md-12">
			...
			<button class="btn btn-primary" name="act" value="all" style="margin-top:30px;">ค้นหาทุกรายการทั้งหมด</button>
									...
									<div class="table-responsive">
										...
										$phone = $_GET['phone_dp'];
										if ($phone != '') {
											$sql75 = "UPDATE code_update SET code = '$phone'WHERE id = 1 ";
										...
										if ($act == '01') {
											$query = "SELECT * FROM member WHERE aff = '$code' ORDER BY id_mb DESC";
			...
			<th align='center' width='25%'>ยอดฝากรวมของสมาชิกทั้งหมด</th>
			...
			<th align='center'>กำไร-ขาดทุน</th>
										...
										while ($row = mysqli_fetch_array($result)) {
											...
											$query8 = "SELECT SUM(amount_dp) FROM deposit WHERE confirm_dp = 'อนุมัติ' AND phone_dp = '$phone_dp' AND promotion_dp NOT LIKE '%เครดิตฟรี%' AND date_dp LIKE '%$datedp%'";
											...
											$query9 = "SELECT SUM(amount_wd) FROM withdraw WHERE confirm_wd = 'อนุมัติ' AND phone_wd = '$phone_dp' AND date_wd LIKE '%$datedp%'";
			...
			$('.table').not(".table-not").DataTable({
				...
				buttons: [
					'copy', 'csv', 'excel', 'pdf', 'print'
							...
							<div class="table-responsive">
								<?php
								$query = "SELECT * FROM withdrawaff WHERE confirm_aff != 'รอดำเนินการ' ORDER BY id DESC";
								$result = mysqli_query($con, $query);
