...
<?php
	$query = "SELECT * FROM member WHERE phone_mb != '' ORDER BY id_mb desc" or die("Error:" . mysqli_error());
	...
	echo "<tr align='center'>
			...
			<th align='center'>เบอร์ทรูวอเล็ต</th>
	...
	echo '<tbody>';
		...
		echo'<tr>';?>
			...
			<a href='userupdateform.php?id_mb=$row[0]'>
			<button class='btn btn-primary '>
			<font color='white'>แก้ไข</font>
			</button></a></td> ";
