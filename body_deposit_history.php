								...
								<div class="col-md-12">
									...
									<div class="table-responsive">
										...
										if ($act == 'search') {
											...
											$query = "SELECT * FROM deposit WHERE confirm_dp != 'รอดำเนินการ' AND amount_dp != 'กิจกรรม' AND phone_dp LIKE '%$phone%' OR username_dp LIKE '%$test%' ORDER BY id DESC";
										} elseif ($act == 100) {
											$query = "SELECT * FROM deposit WHERE confirm_dp != 'รอดำเนินการ' AND amount_dp != 'กิจกรรม' ORDER BY id DESC LIMIT 100";
										} elseif ($act == 500) {
											$query = "SELECT * FROM deposit WHERE confirm_dp != 'รอดำเนินการ' AND amount_dp != 'กิจกรรม' ORDER BY id DESC LIMIT 500";
										} elseif ($act == 1000) {
											$query = "SELECT * FROM deposit WHERE confirm_dp != 'รอดำเนินการ' AND amount_dp != 'กิจกรรม' ORDER BY id DESC LIMIT 1000";
										} else {
											$query = "SELECT * FROM deposit WHERE confirm_dp != 'รอดำเนินการ' AND amount_dp != 'กิจกรรม' ORDER BY id DESC";
										}
